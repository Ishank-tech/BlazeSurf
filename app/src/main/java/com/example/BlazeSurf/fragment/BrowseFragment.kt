package com.example.BlazeSurf.fragment
...
import com.example.BlazeSurf.activity.MainActivity
import com.example.BlazeSurf.databinding.FragmentBrowseBinding
import com.example.BlazeSurf.activity.DownloadActivity
import com.example.BlazeSurf.model.DownloadModel
import com.example.BlazeSurf.room.Dao
...
class BrowseFragment(private var urlNew: String) : Fragment() {
    ...
    private fun saveFileToDataBase(
        ...
        GlobalScope.launch {
            val currentnum: Number = downloadsDao.getAllDownloads().size
           val nextId = currentnum.toInt() + 1
            ...
            downloadsDao.upsertDownload(downloadModel)
        }
    }
